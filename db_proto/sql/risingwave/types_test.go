...
func TestMapSemanticType(t *testing.T) {
	tests := []struct {
		...
		{
			name:          "uint256 maps to rw_int256",
		...
		{
			name:          "address maps to VARCHAR(42)",
			semanticType:  sql2.SemanticAddress,
			expectedSQL:   "VARCHAR(42)",
			shouldSupport: true,
		},
		{
			name:          "hash maps to VARCHAR(66)",
			semanticType:  sql2.SemanticHash,
			expectedSQL:   "VARCHAR(66)",
			shouldSupport: true,
		},
		{
			name:          "decimal18 maps to NUMERIC(78,18)",
			semanticType:  sql2.SemanticDecimal18,
			expectedSQL:   "NUMERIC(78,18)",
			shouldSupport: true,
		},
		{
