...
func NewDatabase(schemaName string, dialect *DialectRisingwave, db *pqsql.DB, moduleOutputType string, rootMessageDescriptor *desc.MessageDescriptor, useProtoOptions bool, logger *zap.Logger) (*Database, error) {
